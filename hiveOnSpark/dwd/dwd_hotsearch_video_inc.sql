drop table if exists dwd_hotsearch_video_inc;
create external table dwd_hotsearch_video_inc(
	  ...
	  `video_urls` array<string> COMMENT '图片url', 
	  ...
	  `local_path` array<string> COMMENT '视频本地地址',
...
STORED AS ORC
LOCATION '/warehouse/yuqing/dwd/dwd_hotsearch_video_inc/'
