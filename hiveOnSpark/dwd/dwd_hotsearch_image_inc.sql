drop table if exists dwd_hotsearch_textimage_inc;
create external table dwd_hotsearch_textimage_inc(
	  ...
	  `picture_urls` array<string> COMMENT '图片url', 
	  ...
	  `local_path` array<string> COMMENT '图片本地地址',
...
STORED AS ORC
LOCATION '/warehouse/yuqing/dwd/dwd_hotsearch_textimage_inc/'
